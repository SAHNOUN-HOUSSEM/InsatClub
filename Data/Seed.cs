        ...
        public static void SeedData(IApplicationBuilder applicationBuilder)
        {
            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Clubs.Any())
                {
                    ...
                    {
                        Title = BASKETBALL,
                        Image = "https://img.freepik.com/vecteurs-libre/ballon-basket-ball_78370-347.jpg?size=338&ext=jpg&ga=GA1.1.1788068356.1706313600&semt=ais",
                    ...
                    {
                        Title = CHESS,
                        Image = "https://img.freepik.com/vecteurs-libre/roi-jeu-echecs_78370-348.jpg?size=338&ext=jpg&ga=GA1.1.1788068356.1706313600&semt=ais",
